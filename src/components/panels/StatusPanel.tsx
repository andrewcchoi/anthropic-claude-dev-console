      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-2xl max-h-[80vh] overflow-hidden flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <button
            ...
            className="text-gray-500 hover:text-gray-900 dark:hover:text-gray-100 active:scale-[0.95] transition-all duration-150"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-3 space-y-2">
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400">
                Enable debug mode to view detailed logs and diagnostic information
              </p>
            </div>
          </div>
